...
type WelcomeModalProps = {
  onSelectTemplateAction: (template: "blank" | "template") => void;
};

export const WelcomeModal: React.FC<WelcomeModalProps> = ({
  onSelectTemplateAction,
}) => (
  <Modal onClose={() => onSelectTemplateAction("blank")}>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Track your planned budget against actual expenses. Make corrections
            throughout the year to see how your financial horizon changes.
          </p>
        </div>
      </div>
      <div className="flex items-start gap-4">
    ...
    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
      <button
        onClick={() => onSelectTemplateAction("blank")}
